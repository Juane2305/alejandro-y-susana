...
const LugaresLineal = ({borderColor, buttonStyle, iglesia, hora_iglesia, salon, hora_civil, hora_fiesta, link_ceremonia, link_fiesta}) => {
  ...
  const lugares = [
    { 
      ...
      descripcion: `${iglesia} a las ${hora_iglesia}`,
      imagen: "https://res.cloudinary.com/dfschbyq2/image/upload/v1764775309/WhatsApp_Image_2025-12-02_at_11.11.56_AM_sf5oku.jpg"
    },
    // { id: 2, titulo: "Ceremonia Civil", descripcion: `${salon} a las ${hora_civil}` },
    { 
      id: 3, 
      titulo: "Fiesta", 
      descripcion: `${salon} a las ${hora_fiesta}` 
    },
  ];
        ...
        {lugares.map((lugar) => {
          ...
          return (
            <div
              key={lugar.id}
              ref={ref}
              className={`p-6 shadow-md rounded-xl bg-white mx-auto w-full text-center transition-all duration-300 overflow-hidden ${
                inView
              ...
              {lugar.imagen && (
                <div className="mb-4 -mx-6 -mt-6">
                  <img 
                    src={lugar.imagen} 
                    alt={lugar.titulo}
                    className="w-full h-80 object-cover md:object-contain"
                  />
                </div>
              )}
